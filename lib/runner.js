...
const { startTimer, stopTimer, formatNumber, checkForJsonConfigs, writeTestResultsToJson, getFullTestDirectory, getFilesRecursively } = require('./util');
...
class Runner {
    ...
    async loadTestsFromDirectory() {
        ...
        if (this.config.usePattern) {
            ...
            testFiles = getFilesRecursively(testDirPath, 'test.js');
        }
