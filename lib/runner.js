...
class Runner {
    ...
    async execute() {
        ...
        console.log(`${green}${figlet.textSync('TestLab.JS', { horizontalLayout: 'full' })}${def}\n`);
        console.log(`${cyan}Version:${def} ${version}\n`);
        console.log(`${blue}TestLab.js${def} - Running tests in directory: ${cyan}${config.testDirectory}${def}\n`);
        ...
        for (const { description, fn} of this.tests) {
            ...
            try {
                ...
                console.log(`✅ ${green}Passed: ${description}${def}`);
            } catch (error) {
                this.failed++;
                console.error(`❌${red}Failed: ${description}${def}`);
